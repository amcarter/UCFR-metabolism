...
dd<- dd %>%
    ...
    # mutate(across(starts_with(c( 'epil', 'fila')), ~ log(.))) %>%
...
P_mod <- stan_model("code/model/stan_code/GPP_biomass_model_ar1_noK600_hierarchical.stan")
P_mod_nb <- stan_model("code/model/stan_code/GPP_NObiomass_model_ar1_noK600_hierarchical.stan")
