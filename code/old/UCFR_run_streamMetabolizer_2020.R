...
DL<-read_csv('data/prepared_data/DL_2021.csv')
DL<-read_csv('data/prepared_data/DL_2020.csv')%>%
    bind_rows(DL)

GR<-read_csv('data/prepared_data/GR_2021.csv')
GR<-read_csv('data/prepared_data/GR_2020.csv')%>%
    bind_rows(GR)

GC<-read_csv('data/prepared_data/GC_2021.csv')
GC<-read_csv('data/prepared_data/GC_2020.csv')%>%
    bind_rows(GC)

BM<-read_csv('data/prepared_data/BM_2021.csv')
BM<-read_csv('data/prepared_data/BM_2020.csv')%>%
    bind_rows(BM)

BN<-read_csv('data/prepared_data/BN_2021.csv')
