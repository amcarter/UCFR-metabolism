...
saveRDS(PL_fit, 'data/metab_fits/PL_knorm_oipi.rds')
...
saveRDS(DL_fit, 'data/metab_fits/DL_knorm_oipi.rds')
...
saveRDS(GR_fit, 'data/metab_fits/GR_knorm_oipi.rds')
...
saveRDS(GC_fit, 'data/metab_fits/GC_knorm_oipi.rds')
...
saveRDS(BM_fit, 'data/metab_fits/BM_knorm_oipi.rds')
...
saveRDS(BN_fit, 'data/metab_fits/BN_knorm_oipi.rds')
