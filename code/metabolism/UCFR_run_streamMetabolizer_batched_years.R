...
PL<-read_csv('data/prepared_data/PL2020_2021.csv')
DL<-read_csv('data/prepared_data/DL2020_2021.csv')
GR<-read_csv('data/prepared_data/GR2020_2021.csv')
GC<-read_csv('data/prepared_data/GC2020_2021.csv')
BM<-read_csv('data/prepared_data/BM2020_2021.csv')
BN<-read_csv('data/prepared_data/BN2020_2021.csv')
