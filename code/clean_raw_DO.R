...
flag_points <- data.frame(MST = c(ymd_hms(
    ...
    seq(ymd_hms('2021-10-28 16:46:00'), ymd_hms('2021-10-28 17:16:00'), by = 'min'),
    seq(ymd_hms('2021-11-06 12:01:00'), ymd_hms('2021-11-29 09:31:00'), by = 'min')
),
flag = 'bad data')
dt <- as.numeric(median(diff(dat$UTC)))
...
flag_points <- data.frame(MST = c(
    ...
    seq(ymd_hms('2021-11-15 11:14:00'),
...
flag_points <- data.frame(MST = c(
    ...
    seq(ymd_hms('2021-09-06 04:26:00'),
        ...
        by = 'min'),
    seq(ymd_hms('2021-11-14 16:26:00'),
        ymd_hms('2021-11-14 17:41:00'),
        by = 'min'),
    seq(ymd_hms('2021-11-15 12:56:00'),
